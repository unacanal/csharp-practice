...
namespace WpfApplication1
{
    ...
    // delegate = 대리자. 이런 형태의 signature를 갖고있는 함수를 대신 실행시켜주는 놈을 만든 것.
    delegate int myDelegate(Label label); // class 밖에 delegate 정의
    public partial class MainWindow : Window
    {
        ...
        private void button_Click(object sender, RoutedEventArgs e) // 이벤트 발생할때 어떤 값을 주면 args안에 담겨서 옴 // sender: window form
        {
            ...
            md.BeginInvoke(lbl_hello, SumCallback, "test"); // test는 쓰레기값...? 용도 잘모름
        }
